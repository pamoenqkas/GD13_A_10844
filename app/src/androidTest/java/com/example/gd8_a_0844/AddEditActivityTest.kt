...
class AddEditActivityTest {
    ...
    fun addEditActivityTest() {
        ...
        textInputEditText4.perform(scrollTo(), replaceText("Tt"), closeSoftKeyboard())
        ...
        textInputEditText5.perform(scrollTo(), replaceText("25"), closeSoftKeyboard())
        ...
        textInputEditText6.perform(scrollTo(), replaceText("FTI"), closeSoftKeyboard())
        ...
        textInputEditText7.perform(scrollTo(),replaceText("Informatika"), closeSoftKeyboard())
